...
if (!fs.existsSync(process.cwd() + '/Shankar_Database') || !fs.existsSync(process.cwd() + '/Shankar_Database/RandPass.json')) {
  ...
  fs.writeFileSync(process.cwd() + '/Shankar_Database/RandPass.json', JSON.stringify(ArrPassWord, null, 2), 'utf8');
}

else {
  ArrPassWord = JSON.stringify(fs.readFileSync(process.cwd() + '/Shankar_Database/RandPass.json'));
}
